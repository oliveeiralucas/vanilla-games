      ...
      <div className='mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32 relative z-10'>
          ...
          {menuItems.map((item) => (
            <div key={item.label}>
              {item.children ? (
                ...
                <Link href={item.href} className='text-sm font-semibold text-white hover:underline'>
                  {item.label}
                </Link>
              )}
            </div>
        ...
        <div className='mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between'>
          <div>
            ...
            <p className='mt-2 text-sm text-gray-300'>As últimas atualizações direto no seu e-mail.</p>
          </div>
